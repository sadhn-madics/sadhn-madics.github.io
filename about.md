...
**Thématiques concernées :** représentation, raisonnement et analyse sur des données en humanités numériques.

**Type de données :** données à dimensions spatiale – temporelle – incertaine – incomplète.

**Domaines d'applications scientifiques des données impliqués :** domaines scientifiques en lien avec les humanités numériques au sens large comme par exemple l’Informatique, les Mathématiques Appliquées, la Géomatique, l’Histoire, l’Histoire de l'art, la Géographie, l’Archéologie, la Sociologie, la Littérature, l’Economie et la Démographie.

**Enjeux économiques et sociaux :** Les défis sociétaux abordés concernent l'exploitation des sources muséales, archivistiques, scientifiques en cherchant à proposer des approches pour structurer les données, les informations et les connaissances qu'elles contiennent à des fins d'accès, de réutilisation et d’analyses.
